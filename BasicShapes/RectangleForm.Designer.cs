...
namespace BasicShapes
{
    partial class RectangleForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Draw a rectangle by clicking and holding right button.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Click on any rectangle or select some by holding left button, then press DEL butt" +
    "on to delete it.";
            // 
            // RectangleForm
            // 
            ...
            this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.RectangleForm_MouseDown);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.RectangleForm_MouseMove);
            this.MouseUp += new System.Windows.Forms.MouseEventHandler(this.RectangleForm_MouseUp);
